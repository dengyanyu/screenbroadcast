...
**
** Created: Fri Jun 3 11:59:51 2016
...
public:
    ...
    QPushButton *pbroadcast;
    QPushButton *psendDir;
    ...
    void setupUi(QDialog *ChatDialog)
    {
        ...
        pbroadcast = new QPushButton(ChatDialog);
        pbroadcast->setObjectName(QString::fromUtf8("pbroadcast"));

        horizontalLayout_3->addWidget(pbroadcast);

        psendDir = new QPushButton(ChatDialog);
        psendDir->setObjectName(QString::fromUtf8("psendDir"));

        horizontalLayout_3->addWidget(psendDir);
    ...
    void retranslateUi(QDialog *ChatDialog)
    {
        ...
        pbroadcast->setText(QApplication::translate("ChatDialog", "\345\271\277\346\222\255", 0, QApplication::UnicodeUTF8));
        psendDir->setText(QApplication::translate("ChatDialog", "\345\217\221\351\200\201\346\226\207\344\273\266\345\244\271", 0, QApplication::UnicodeUTF8));
        pSendBtn->setText(QApplication::translate("ChatDialog", "\345\217\221\351\200\201\346\226\207\344\273\266", 0, QApplication::UnicodeUTF8));
