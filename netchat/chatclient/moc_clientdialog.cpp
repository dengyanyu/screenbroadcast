...
**
** Created: Fri Jun 3 13:26:54 2016
...
static const char qt_meta_stringdata_ClientDialog[] = {
    "ClientDialog\0\0slotGetServerPort()\0"
    "slot_connected_to_server()\0"
    "slot_disconnected_to_server()\0"
    "on_pExit_clicked()\0"
};

const QMetaObject ClientDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ClientDialog,
      qt_meta_data_ClientDialog, 0 }
};
...
int ClientDialog::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: slotGetServerPort(); break;
        case 1: slot_connected_to_server(); break;
        case 2: slot_disconnected_to_server(); break;
        case 3: on_pExit_clicked(); break;
        default: ;
        }
        _id -= 4;
    }
